...
# --- Configuration ---
PROJECT_ID = os.getenv("GOOGLE_CLOUD_PROJECT", "sunlit-segment-396117")
SEARCH_PROJECT_ID = os.getenv("VERTEX_SEARCH_PROJECT", "bold-kit-384717")
LOCATION = os.getenv("VERTEX_SEARCH_LOCATION", "global")
SEARCH_APP_ID = os.getenv("VERTEX_SEARCH_APP_ID", "askhr2_1774835344122")
...
def search_hr_policy(query: str,tool_context: ToolContext) -> str:
    ...
    try:
        ...
        serving_config = f"projects/{SEARCH_PROJECT_ID}/locations/{LOCATION}/collections/default_collection/engines/{SEARCH_APP_ID}/servingConfigs/default_search"
