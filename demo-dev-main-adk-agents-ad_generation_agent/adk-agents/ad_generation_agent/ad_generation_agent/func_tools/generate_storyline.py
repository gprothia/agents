...
async def generate_storyline(
    ...
    try:
        ...
        utils_agents.agentspace_print(tool_context, f"Generating storyline for {product_name}...")
        ...
        utils_agents.agentspace_print(tool_context, "Storyline text generated.")
        ...
        utils_agents.agentspace_print(tool_context, "Storyline generation complete.")
