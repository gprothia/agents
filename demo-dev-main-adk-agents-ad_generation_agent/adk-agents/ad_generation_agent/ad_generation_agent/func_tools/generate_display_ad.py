...
async def generate_display_ad(
    ...
    Args:
        ...
        reference_images (List[str], optional): List of URIs for additional reference images. Defaults to [].
        product_image_reference (str, optional): A URI or path to the canonical product image. Defaults to "".
    ...
    try:
        ...
        final_product_uri = product_image_reference or backup_media_configs.get_backup_catalog_image_url()
