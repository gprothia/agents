...
async def combine(
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            utils_agents.agentspace_print(tool_context, "Combining video clips and audio...")
            ...
            if not result:
                ...
                utils_agents.agentspace_print(tool_context, "Final video combined and uploaded.")
